...
# @new
Сценарий: Получение случайного вопроса
Допустим я делаю запрос создания цифрового вопроса от лица админа l="admin" p="admin"
...
И я делаю запрос создания вариантивного вопроса от лица админа l="admin" p="admin"
Когда я запрашиваю случайный числовой вопрос
И я запрашиваю случайный числовой вопрос
То это должны быть два разных вопроса
